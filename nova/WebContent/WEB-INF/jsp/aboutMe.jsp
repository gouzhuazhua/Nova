		...
		<div id="content">
			...
			<div class="widget widget-4 finances_summary" >
				<div class="widget-body" style="padding: 10px 0;">
					<div class="row-fluid">
						<div class="span4">
							<div class="well" id="well" style="background-color: #66ccff">
								昵称/personaname					<strong><span class="glyphicons flash standard"><i></i></span>${profile.personaname}</strong>
							</div>
	
							<div class="well">
								steamid					<strong>${profile.steamid}</strong>
							</div>
							
							<div class="well">
								vac封禁/vacbanned						<strong>${profile.vacbanned}</strong>
							</div>
							
							<div class="well" style="">
								游戏封禁次数/numberofgamebans				<strong>${profile.numberofgamebans}</strong>
							</div>
						</div>
						<div class="span4">
							<div class="well">
								状态/personastate					<strong>${profile.personastate}</strong>
							</div>
	
							<div class="well">
								等级/level			<strong>${profile.player_level}</strong>
							</div>
							
							<div class="well">
								社区封禁/communitybanned			<strong>${profile.communitybanned}</strong>
							</div>
							
							<div class="well" style="">
								上次在线/lastlogoff		<strong>${profile.lastlogoff}</strong>
							</div>
						</div>
						<div class="span4">
							<div class="well">
								正在玩/ingame					<strong id="well-strong">N/A</strong>
							</div>
	
							<div class="well">
								国籍/country					<strong>${profile.loccountrycode}</strong>
							</div>
							
							<div class="well">
								账户封禁/economyban					<strong>${profile.economyban}</strong>
							</div>
							
							<div class="well" style="">
								注册时间/timecreated					<strong>${profile.timecreated}</strong>
							</div>
						</div>
					</div>
			...
			<h3> 最近游戏<span>|Recently played games</span> </h3>
			<div class="widget widget-4 widget-body-white">
				<div class="widget-body" style="padding: 10px 0 0;">
					<table class="table table-bordered table-primary">
						...
						<tbody>
						<c:forEach items="${recentlyPlayedGames}" var="game" varStatus="currentStatus">
							<tr>
								<td class="center">${currentStatus.count }</td>
								<td>${game.appname }</td>
								<td><img src="${game.img_logo_url }"></td>
								<td>${game.playtime_2weeks } 小时</td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
			...
			<h3> 我的游戏<span>|Owned games</span> </h3>
			<div class="widget widget-4 widget-body-white">
				<div class="widget-body" style="padding: 10px 0 0;">
					<table class="dynamicTable table table-striped table-bordered table-primary table-condensed">
						...
						<tbody>
						<c:forEach items="${ownedGames}" var="game" varStatus="currentStatus">
							<tr class="gradeX">
								<td class="center">${currentStatus.count}</td>
								<td>${game.appname }</td>
								<td><img src="${game.img_logo_url }"></td>
								<td>${game.playtime_forever } 小时</td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
