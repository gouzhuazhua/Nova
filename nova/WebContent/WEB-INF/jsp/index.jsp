...
<body>
	<script type="text/javascript" color="0,0,0" opacity='0.7' zIndex="-2" count="400" src="${basePath}/statics/user-res/theme/canvas-nest.min.js"></script>
			...
			<div class="row">
				<div class="span12 relativeWrap">
					...
					<ul id="menu" class="hidden-phone">
						<li class="active">
							<a href="${basePath}/index.htm" class="menuToggle">新闻</a>
						</li>
						<li >
					...
					<span class="profile">
						<span>
							<strong>你好游客，请</strong>
							<a href="${basePath}/login-form">登录 |</a>
							<a href="${basePath}/register-form">注册</a>
						</span>
					</span>
	...
	<div class="container-fluid fixed">	
		<div id="content">
		<ul class="breadcrumb">
				<li><a href="${basePath}/index.htm" class="glyphicons home"><i></i> AIR -Tree</a></li>
				<li class="divider"></li>
				<li>index</li>
			</ul>
